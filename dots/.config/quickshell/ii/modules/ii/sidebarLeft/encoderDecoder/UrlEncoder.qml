...
Item {
    ...
    function processText() {
        ...
        if (root.isEncodeMode) {
            root.encodedText = root.encodeUrl(inputText);
            root.decodedText = "";
        } else {
            root.decodedText = root.decodeUrl(inputText);
            root.encodedText = "";
        }
    }
    ...
    ColumnLayout {
            ...
            ColumnLayout {
                ...
                EncodingCanvas { // Output
                    ...
                    placeholderText: root.isEncodeMode ? 
                        Translation.tr("URL encoded text will appear here...") :
        ...
        EncodingCanvas { // Input
            ...
            isInput: true
            placeholderText: root.isEncodeMode ? 
                Translation.tr("Enter text to URL encode...") :
                Translation.tr("Enter URL-encoded text to decode...")
            onInputTextChanged: {
                root.processText();
            }
            GroupButton {
