...
ContentPage {
    ...
    ContentSection {
        ...
        MaterialTextArea {
            ...
            onTextChanged: { Qt.callLater(() => { Config.options.time.format = text; Config.save() }) }
        }
        ...
        ConfigSwitch {
            ...
            onCheckedChanged: { Config.options.time.secondPrecision = checked; Config.save() }
        }
    }
    ...
    ContentSection {
        ...
        MaterialTextArea {
            ...
            onTextChanged: { Qt.callLater(() => { Config.options.time.shortDateFormat = text; Config.save() }) }
        }
        MaterialTextArea {
            Layout.fillWidth: true
            placeholderText: Translation.tr("Full date format (e.g. ddd, dd/MM)")
            text: Config.options.time.dateFormat
            onTextChanged: { Qt.callLater(() => { Config.options.time.dateFormat = text; Config.save() }) }
        }
        MaterialTextArea {
            Layout.fillWidth: true
            placeholderText: Translation.tr("Calendar locale (e.g. en-GB)")
            text: Config.options.calendar.locale
            onTextChanged: { Qt.callLater(() => { Config.options.calendar.locale = text; Config.save() }) }
        }
    }
    ...
    ContentSection {
        ...
        ConfigSpinBox {
            ...
            onValueChanged: { Config.options.time.pomodoro.focus = value; Config.save() }
        }
        ConfigSpinBox {
            ...
            onValueChanged: { Config.options.time.pomodoro.breakTime = value; Config.save() }
        }
        ConfigSpinBox {
            icon: "coffee"
            ...
            onValueChanged: { Config.options.time.pomodoro.longBreak = value; Config.save() }
        }
        ConfigSpinBox {
            icon: "loop"
            ...
            onValueChanged: { Config.options.time.pomodoro.cyclesBeforeLongBreak = value; Config.save() }
        }
    }
}
