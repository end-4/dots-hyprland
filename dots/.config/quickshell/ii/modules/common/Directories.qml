...
Singleton {
    ...
    property string orbitbarStateDir: FileUtils.trimFileProtocol(`${Directories.state}/user/orbitbar`)
    property string orbitbarStatePath: FileUtils.trimFileProtocol(`${Directories.orbitbarStateDir}/state.json`)
    property string orbitbarSocketPath: FileUtils.trimFileProtocol(`${Directories.orbitbarStateDir}/orbitbar.sock`)
    ...
    Component.onCompleted: {
        ...
        Quickshell.execDetached(["mkdir", "-p", `${orbitbarStateDir}`])
