    ...
    const realCoverArt = Box({
        ...
        attribute: {
            ...
            'updateCover': (self) => {
                ...
                // Generate colors
                execAsync(['bash', '-c',
                    `python ${App.configDir}/scripts/color_generation/generate_colors_material.py --path '${coverPath}' --mode ${darkMode.value ? 'dark' : 'light'} > ${GLib.get_user_state_dir()}/ags/scss/_musicmaterial.scss`])
                    .then(() => {
