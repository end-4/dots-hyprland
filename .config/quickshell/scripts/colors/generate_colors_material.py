...
parser.add_argument('--harmony', type=float , default=0.2, help='(0-1) Color hue shift towards accent')
parser.add_argument('--harmonize_threshold', type=float , default=20, help='(0-180) Max threshold angle to limit color hue shift')
