    ...
    ContentSection {
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                // spacing: 10
                StyledText {
                    text: "Illogical UWSM Ultimate"
                    font.pixelSize: Appearance.font.pixelSize.title
                }
                StyledText {
                    text: "https://github.com/PhoenixAceVFX/Illogical-UWSM-Ultimate"
                    font.pixelSize: Appearance.font.pixelSize.normal
                    textFormat: Text.MarkdownText
                    onLinkActivated: (link) => {
                        Qt.openUrlExternally(link)
        ...
        Flow {
            ...
            RippleButtonWithIcon {
                ...
                mainText: "Issues"
                onClicked: {
                    Qt.openUrlExternally("https://github.com/PhoenixAceVFX/Illogical-UWSM-Ultimate/issues")
                }
            }
        }
    }
