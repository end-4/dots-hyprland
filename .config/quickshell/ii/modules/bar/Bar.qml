                    ...
                    MouseArea { // Right side | scroll to change volume
                        ...
                        Item {
                            ...
                            RowLayout {
                                ...
                                // Pomodoro
                                RowLayout {
                                    visible: Config.pomodoroRunning || !Config.pomodoroAtInitialState
                                    Layout.alignment: Qt.AlignVCenter
                                    spacing: 5
                                    Layout.rightMargin: 10 // Aumenta a distância
                                    Layout.minimumWidth: 80 // Largura mínima para evitar trepidação

                                    CircularProgress {
                                        lineWidth: 2
                                        value: Config.pomodoroProgress
                                        size: 26
