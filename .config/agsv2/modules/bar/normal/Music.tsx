...
function BarResource({
    ...
    return (
        <button
            onClick={onClick}
            tooltipText={bind(percentage).as((percentage) => `${name}: ${Math.round(percentage)}%`)}
        >
                ...
                <box>
                    <BarResource
                        ...
                        circprogClassName={`bar-ram-circprog ${
                            userOptions.appearance.borderless ? 'bar-ram-circprog-borderless' : ''
                        }`}
                    ...
                    <box className="spacing-h-10 margin-left-10">
                        <BarResource
                            ...
                            circprogClassName={`bar-swap-circprog ${
                                userOptions.appearance.borderless ? 'bar-swap-circprog-borderless' : ''
                            }`}
                        ...
                        <BarResource
                            ...
                            circprogClassName={`bar-cpu-circprog ${
                                userOptions.appearance.borderless ? 'bar-cpu-circprog-borderless' : ''
                            }`}
...
export default function Music() {
    ...
    function nameSetup(self: Astal.Label, players: AstalMpris.Player[] = mpris.players) {
        ...
        const display = Variable.derive([bind(player, 'title'), bind(player, 'artist')], (title, artist) => {
