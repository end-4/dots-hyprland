...
const HISTORY_DIR = `${GLib.get_user_state_dir()}/agsv2/user/ai/chats/`;
...
Utils.exec(`mkdir -p ${GLib.get_user_state_dir()}/agsv2/user/ai`);
const KEY_FILE_LOCATION = `${GLib.get_user_state_dir()}/agsv2/user/ai/google_key.txt`;
const APIDOM_FILE_LOCATION = `${GLib.get_user_state_dir()}/agsv2/user/ai/google_api_dom.txt`;
