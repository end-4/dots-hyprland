...
ContentPage {
    ...
    ContentSection {
        ...
        ContentSubsection {
            title: Translation.tr("Sidebar transparency")

            ConfigSwitch {
                text: Translation.tr("Enable")
                checked: Config.options.appearance.sidebarTransparency.enable
                onCheckedChanged: {
                    Config.options.appearance.sidebarTransparency.enable = checked;
                }
            }
            ConfigSpinBox {
                text: Translation.tr("Transparency")
                value: Config.options.appearance.sidebarTransparency.transparency * 100
                from: 0
                to: 100
                stepSize: 1
                onValueChanged: {
                   Config.options.appearance.sidebarTransparency.transparency = value / 100;
                }
            }
        }
