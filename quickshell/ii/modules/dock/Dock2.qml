...
Scope { // Scope
    ...
    function componentFor(type) {
        ...
        function applyAlignment(item, align) {
            if (align === "fill") {
                item.Layout.fillWidth = true
            } else if (!isNaN(parseFloat(align))) {
                item.Layout.preferredWidth = parseFloat(align)
            }
            if (align === "left") {
                item.Layout.alignment = Qt.AlignLeft | Qt.AlignVCenter
            } else if (align === "center") {
                item.Layout.alignment = Qt.AlignHCenter | Qt.AlignVCenter
            } else if (align === "right") {
                ...
                Item {
                    ...
                    Item { // Wrapper for the dock background
                        ...
                        RowLayout {
                            ...
                            Repeater {
                                model: Config.options?.dock.items ?? ["pinnedApps"]
                                delegate: Loader {
                                    required property string modelData
                                    required property int index


                                    property string align: Config.options?.dock.alignments[index] ?? "center"
                                    sourceComponent: {

                                        return root.componentFor(modelData)
                                    }

                                    // Component.onCompleted: root.applyAlignment(this, align)
                                }
                            }
