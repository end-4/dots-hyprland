...
MouseArea { // Notification group area
    ...
    Rectangle { // Background of the notification
        ...
        width: parent.width
        // color: popup ? ColorUtils.applyAlpha(Appearance.colors.colLayer2, 1 - Appearance.backgroundTransparency) : Appearance.m3colors.m3surfaceContainerHigh
         color: popup ? ColorUtils.applyAlpha(Appearance.colors.colLayer2, 1 - Appearance.backgroundTransparency) : Appearance.colors.colSurfaceContainer
            ...
            ColumnLayout { // Content
                ...
                StyledListView { // Notification body (expanded)
                    ...
                    delegate: NotificationItem {
                        ...
                        opacity: (!root.expanded && index == 1 && root.notificationCount > 2) ? 0.4 : 1
                        fontSize: (!root.expanded && index == 1 && root.notificationCount > 2) ? Appearance?.font.pixelSize.smaller : Appearance?.font.pixelSize.small
