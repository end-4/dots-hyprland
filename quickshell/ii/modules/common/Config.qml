    ...
    FileView {
        ...
        JsonAdapter {
            ...
            property JsonObject appearance: JsonObject {
                ...
                property JsonObject sidebarTransparency: JsonObject {
                    property bool enable: false
            ...
            property JsonObject input: JsonObject {
                property string kb_layout: "us,ru"
                property string kb_options: "grp:alt_shift_toggle"
                property bool numlock_by_default: false
                property int repeat_delay: 250
                property int repeat_rate: 35
                property int follow_mouse: 1
                property string accel_profile: "adaptive"
                property real sensitivity: 0.0

                property JsonObject touchpad: JsonObject {
                    property bool natural_scroll: false
