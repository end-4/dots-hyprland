        ...
        Item { // Messages
            ...
            Item { // Placeholder when list is empty
                ...
                ColumnLayout {
                    ...
                    // Reusable component for styled text with common properties
                    component StyledLabel: StyledText {
                        Layout.fillWidth: true
                        font.pixelSize: Appearance.font.pixelSize.small
                    ...
                    // Component for shortcut keys with keyboard key styling
                    component ShortcutKey: Item {
                        property alias textContent: label.text
                        Layout.fillWidth: false
                        implicitHeight: label.implicitHeight + 8 // Add padding for background
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            ShortcutKey {
                                id: widgetDescriptionShortcut1
                                textContent: Translation.tr("Ctrl+O")
                            }

                            StyledLabel {
                                id: widgetDescriptionText1
                                font.family: Appearance.font.family.main
                                text: Translation.tr("to expand the sidebar")
                            }
                        }
                        ...
                        RowLayout {
                            ...
                            ShortcutKey {
                                id: widgetDescriptionShortcut2
                                textContent: Translation.tr("Ctrl+P")
                            }

                            StyledLabel {
                                id: widgetDescriptionText2
                                font.family: Appearance.font.family.main
                                text: Translation.tr("to detach sidebar into a window")
                            }
                        }
                    }
                }
