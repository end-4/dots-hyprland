...
Item { // Bar content region
    ...
    Rectangle {
        ...
        color: Config.options.bar.showBackground ? Qt.rgba(Appearance.colors.colLayer0.r, Appearance.colors.colLayer0.g, Appearance.colors.colLayer0.b, Config.options.appearance.sidebarTransparency.enable ? Config.options.appearance.sidebarTransparency.transparency : 1.0) : "transparent"
