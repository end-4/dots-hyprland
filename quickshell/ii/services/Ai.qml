...
Singleton {
    ...
    property var models: Config.options.policies.ai === 2 ? {} : {
        ...
        "nemotron-nano-9b": aiModelComponent.createObject(this, {
            "name": "Nvidia Nemotron Nano v2",
            "icon": "spark-symbolic",
            "description": "Вторая версия мельенькой языковой модели от Nvidia с функцией инструментов",
            "homepage": "https://openrouter.ai/nvidia/nemotron-nano-9b-v2:free",
            "endpoint": "https://openrouter.ai/api/v1/chat/completions",
            "model": "nvidia/nemotron-nano-9b-v2:free", // Это имя отправляется в API
            "requires_key": true,
            "key_id": "openrouter",
            "key_get_link": "https://openrouter.ai/settings/keys",
            "key_get_description": Translation.tr("**Pricing**: free. Data use policy varies depending on your OpenRouter account settings.\n\n**Instructions**: Log into OpenRouter account, go to Keys on the topright menu, click Create API Key"),
